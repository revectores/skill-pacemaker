...
“学习”, “社区”以及"用户"三栏，点击分别进入控制台页面`/domain/dashboard.html`, 社区主页`/community/index.html`以及用户信息页面`/user.html`. 菜单栏在所有页面的顶部（web端）或底部（移动端）显示.
...
- 内容：
    1. “返回”按钮，可返回控制台`/domain/dashboard.html`.
