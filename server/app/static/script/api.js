...
const GET_SECTION_API 			= SECTION_ROOT + '/get'
const GET_SECTION_BY_DOMAIN_API = SECTION_ROOT + '/get_by_domain'
const GET_SECTION_TREE_API 		= SECTION_ROOT + '/tree'

const GET_NODE_API 				= NODE_ROOT
const GET_NODE_BY_DOMAIN_API	= NODE_ROOT + '/get_by_domain'
...
get_sections_by_domain =   (domain_id) => req(GET_SECTION_BY_DOMAIN_API)(domain_id);
...
get_nodes_by_domain =	   (domain_id) => req(GET_NODE_BY_DOMAIN_API)(domain_id);
